    ...
    <SafeAreaView style={{ flex: 1, backgroundColor: "#F8F9FA" }}>
      <ScrollView contentContainerStyle={{ padding: 20, paddingBottom: 40 }}>
        ...
        <View style={{
          ...
          {([
            { type: "quizzes"      as HistoryType, labelFr: "Quiz",              labelEn: "Quizzes",          labelAr: "اختبارات",    icon: "🧠" },
            { type: "flashcards"   as HistoryType, labelFr: "Flashcards",        labelEn: "Flashcards",       labelAr: "بطاقات",      icon: "🃏" },
            { type: "plans"        as HistoryType, labelFr: "Plans d'étude",     labelEn: "Study Plans",      labelAr: "خطط الدراسة", icon: "📅" },
            { type: "summaries"    as HistoryType, labelFr: "Résumés",           labelEn: "Summaries",        labelAr: "ملخصات",      icon: "📄" },
            { type: "explanations" as HistoryType, labelFr: "Explications",      labelEn: "Explanations",     labelAr: "شروحات",      icon: "💡" },
            { type: "solutions"    as HistoryType, labelFr: "Solutions",         labelEn: "Solutions",        labelAr: "حلول",        icon: "✏️"  },
          ] as const).map(({ type, labelFr, labelEn, labelAr, icon }, index, arr) => {
            const label = currentLanguage === "ar" ? labelAr : currentLanguage === "en" ? labelEn : labelFr;
            return (
              <View
                key={type}
                style={{
              ...
              >
                <View style={{
                  ...
                  marginRight: currentLanguage === "ar" ? 0 : 12,
                  marginLeft: currentLanguage === "ar" ? 12 : 0,
                }}>
                ...
                <TouchableOpacity
                  onPress={() => confirmDeleteAll(type, label, currentLanguage, () => {})}
                  style={{
